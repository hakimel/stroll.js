 ...
 */
(function(){var b=[];var h=false;function f(){if(h){requestAnimFrame(f);for(var l=0,k=b.length;l<k;l++){b[l].update();}}}function g(o){if(e(o)||!o.nodeName||/^(ul|li)$/i.test(o.nodeName)===false){return false;
